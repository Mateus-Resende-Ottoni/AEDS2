...
class HashDireta {
    ...
    /* Construtor */
    HashDireta(int tamanho, int reserva) {
        this.lista = new Pokemon[tamanho + reserva];
    ...
    void inserir(Pokemon poke) {
        ...
        // Inserir na área reserva
            ...
            while (x < (tamanho + reserva) && inserted == false) {
    ...
    boolean pesquisa(String pokemon, Log operationLog) {
        ...
        // Pesquisar na área reserva
            ...
            pos = tamanho;
            while (pos < (tamanho + reserva) && found == false) {
...
class PokedexHash {
    ...
    public static void main(String[] args) {
        ...
        // Dados
        HashDireta pokedex = new HashDireta(21, 9);
        Log operationLog = new Log("matrícula_hashReserva.txt", 855842);
